/* v1.2.26,1.2.29,1 2018-10-25 10:14:18 */ ! function() {
    function cond() {
        return Math.random()
    }

    function chkQuerySet() {
        var n, e = window[QUERY_KEY];
        return isNaN(e) ? (n = location.href.split(QUERY_KEY + "=")[1], e = parseFloat(n), void(isNaN(e) || (GREY_RATIO = e))) : void(GREY_RATIO = e)
    }
    var GREY_RATIO = 1,
            ...
            ! function(n) {
                ...
                function a(n, e, t) {
                    ...
                    i.onload = function() {
                        ...
                        i.onerror = null, i.parentNode.removeChild(i), -1 != o && (clearTimeout(o), e("err"))
                ...
                function c(n, e, t, i) {
                    function o() {
                        ...
                        var s = n.indexOf("?") > -1 ? "&" : "?",
                            u = n;
                        l > 1 && (u = n + s + "__retry=" + l), a(u, function(n) {
                ...
                function l(n, e, t, i, o) {
                    function r() {
                        ...
                        var l = n.indexOf("?") > -1 ? "&" : "?",
                            f = n;
                        u > 1 && (f = n + l + "__retry=" + u), s(f, e, function(n, e) {
                ...
                function f(n) {
                    var e, t = [],
                        i = f;
                    if ("string" == typeof n) return '"' + n.replace(/(['"\\])/g, "\\$1").replace(/(\n)/g, "\\n").replace(/(\r)/g, "\\r").replace(/(\t)/g, "\\t") + '"';
                ...
                function d(n, e) {
                    e && p(n, e) && (n.classList ? n.classList.remove.apply(n.classList, e.split(/\s+/)) : n.className = n.className.replace(new RegExp("(\\s|^)" + e + "(\\s|$)"), " ").replace(/^\s+|\s+$/g, ""))
                }
                ...
                function _(n, e, t) {
                    if (e = e || v, t = t || "*", v.getElementsByClassName) return e.getElementsByClassName(n);
                    for (var i = [], o = "*" === t && e.all ? e.all : e.getElementsByTagName(t), r = o.length; --r >= 0;) p(o[r], n) && i.push(o[r]);
                    return i
                }
                var g = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(n) {
                    ...
                    w = function(n, e, t) {
                        n.addEventListener ? n.addEventListener(e, t, !1) : n.attachEvent ? n.attachEvent("on" + e, function(n) {
                            return t(n || h.event)
                        }) : n["on" + e] = function(n) {
                            return t(n || h.event)
                        }
                    ...
                    A = function(n) {
                        for (var e = n.offsetLeft, t = n.offsetParent; null !== t;) e += t.offsetLeft, t = t.offsetParent;
                        return e
                    },
                    T = function(n) {
                        for (var e = n.offsetTop, t = n.offsetParent; null !== t;) e += t.offsetTop, t = t.offsetParent;
                        return e
                    };
                n.exports = {
                    addClass: i,
                ...
                function i(n, e, t) {
                    if (n) {
                        var i = 0,
                            o = n.length;
                        if (o === +o)
                            for (; o > i && e.call(t, n[i], i, n) !== !1; i++);
                        else
                            for (i in n)
                                if (n.hasOwnProperty(i) && e.call(t, n[i], i, n) === !1) break
                    }
                }
                ...
                function r(n, e) {
                    e && !o(n, e) && (n.classList ? n.classList.add.apply(n.classList, e.split(/\s+/)) : n.className += " " + e)
                }

                function a(n, e) {
                    e && o(n, e) && (n.classList ? n.classList.remove.apply(n.classList, e.split(/\s+/)) : n.className = n.className.replace(new RegExp("(\\s|^)" + e + "(\\s|$)"), " ").replace(/^\s+|\s+$/g, ""))
                }
                ...
                e.each = i, e.hasClass = o, e.addClass = r, e.removeClass = a, e.toggleClass = function(n, e) {
                    o(n, e) ? a(n, e) : r(n, e)
                }, e.getElementsByClassName = function(n, e, t) {
                    if (e = e || f, t = t || "*", f.getElementsByClassName) return e.getElementsByClassName(n);
                    for (var i = [], r = "*" === t && e.all ? e.all : e.getElementsByTagName(t), a = r.length; --a >= 0;) o(r[a], n) && i.push(r[a]);
                    return i
                }, e.setCookie = function(n, e, t) {
                    t = t || 7;
                    var i = new Date;
                    i.setTime(i.getTime() + 864e5 * t), document.cookie = [encodeURIComponent(n), "=", encodeURIComponent("" + e), ";expires=", i.toGMTString()].join("")
                }, e.send = function(n) {
                    var e = p("_nc_r_"),
                        t = u[e] = new Image;
                ...
                }, e.obj2param = c, e.addHourStamp = function(n, e) {
                ...
                e.isIEX = function(n) {
                    ...
                    return e.innerHTML = "<!--[if IE " + n + "]><i></i><![endif]-->", _[n] = 1 === e.getElementsByTagName("i").length
                };
                ...
                e.getClientRect = function(n) {
                    ...
                    return {
                        left: i,
                        right: i + n.offsetWidth,
                        top: o,
                        bottom: o + n.offsetHeight
                    }
                    ...
                    var t = g(e),
                        i = {
                            x: u.pageXOffset + n.clientX,
                            y: u.pageYOffset + n.clientY
                        };
                    return {
                        offsetX: i.x - t.x,
                        offsetY: i.y - t.y
                ...
                var g = e.getPageCoord = function(n) {
                        for (var e = {
                                x: 0,
                                y: 0
                            }; n;) e.x += n.offsetLeft, e.y += n.offsetTop, n = n.offsetParent;
                        return e
                    },
                    h = {
                        before: function(n, e) {
                ...
                e.decorator = h, e.mix = function(n) {
                    for (var e, t, i = [].slice.call(arguments), o = i.length, r = 1; o > r; r++) {
                        e = i[r];
                        for (t in e) e.hasOwnProperty(t) && (n[t] = e[t])
                    }
                    ...
                    n.removeEventListener ? n.removeEventListener(e, t, !1) : n.detachEvent && n.detachEvent("on" + e, t)
                    ...
                    u[i] = function(n) {
                        e.resolve(n)
                    }, t[n.callback || "callback"] = i, e.promise.always(function() {
                        try {
                            delete u[i]
                        } catch (n) {
                            u[i] = null
                    ...
                    return r.parentNode.insertBefore(o, r), setTimeout(function() {
                        e.reject({
                            type: "request",
                            error: "timeout"
                        })
                    }, 5e3), e.promise
                }, e.getElementLeft = s, e.getElementTop = l
            }, function(n, e, t) {
                "use strict";

                function i(n) {
                    return this instanceof i ? (this._state = l, this._onFulfilled = [], this._onRejected = [], this._value = null, this._reason = null, void(d(n) && n(a(this.resolve, this), a(this.reject, this)))) : new i(n)
                }
                ...
                i.prototype = {
                    ...
                    then: function(n, e) {
                        var t = new i,
                            r = o(t, n, "resolve"),
                            a = o(t, e, "reject");
                        return this._state === u ? r(this._value) : this._state === f ? a(this._reason) : (this._onFulfilled.push(r), this._onRejected.push(a)), t
                    },
                    resolve: function(n) {
                        this._state === l && (this._state = u, this._value = n, s(this._onFulfilled, function(e) {
                            e(n)
                        }), this._onFulfilled = [])
                    },
                    reject: function(n) {
                        this._state === l && (this._state = f, this._reason = n, s(this._onRejected, function(e) {
                            e(n)
                        }), this._onRejected = [])
                    },
                    "catch": function(n) {
                    ...
                    var n = {};
                    return n.promise = new i(function(e, t) {
                        n.resolve = e, n.reject = t
                    }), n
                }, i.race = function(n) {
                    var e = i.defer();
                    return n.length, s(n, function(n) {
                        n.then(function(n) {
                            e.resolve(n)
                        }, function(n) {
                            e.reject(n)
                ...
                e.log = function(n, e) {
                    var t, r, a = e || o,
                        ...
                        s = [],
                        l = c.length;
                    for (t = 0; l > t; t++) r = c[t], n.hasOwnProperty(r) && s.push(r + "=" + encodeURIComponent(n[r]));
                ...
                var d = "";
                d = -1 != u.indexOf("g.alicdn.com") ? "//g.alicdn.com/AWSC/AWSC/awsc.js" : "//aeis.alicdn.com/AWSC/AWSC/awsc.js";
                var p = {
                    0: {
                ...
                n.exports = function() {
                    ...
                    return n.toString = function() {
                        ...
                        for (o = 0; o < e.length; o++) {
                            var a = e[o];
                            "number" == typeof a[0] && i[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = "(" + a[2] + ") and (" + t + ")"), n.push(a))
                        }
                    }, n
                }
            }, , function(n, e) {
                ...
                function o(n, e) {
                    var t = g(),
                        i = m[m.length - 1];
                    if ("top" === n.insertAt) i ? i.nextSibling ? t.insertBefore(e, i.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), m.push(e);
                    else {
                ...
                function s(n, e) {
                    ...
                    } else n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = c(e), i = f.bind(null, t), o = function() {
                        r(t), t.href && URL.revokeObjectURL(t.href)
                    }) : (t = a(e), i = u.bind(null, t), o = function() {
                        r(t)
                    });
                    return i(n),
                        function(e) {
                ...
                var c = "";
                c = -1 != r.indexOf("g.alicdn.com") ? "//g.alicdn.com/AWSC/AWSC/awsc.js" : "//aeis.alicdn.com/AWSC/AWSC/awsc.js";
                var s = {
                    0: {
                ...
                if ("file:" === i.location.protocol) {
                    ...
                    for (l in s)
                        if (s.hasOwnProperty(l)) {
                            u = s[l];
                            for (f in u) u.hasOwnProperty(f) && 0 === u[f].indexOf("//") && (u[f] = "http:" + u[f])
                        }
                }
                e.URL_MAP = s
            }, function(n, e, t) {
                ...
                ! function() {
                    var t = {
                        ...
                        create: function(n, e) {
                            var i = "string" == typeof n.initial ? {
                                ...
                                u = function(n) {
                                    ...
                                    s[n.name] = s[n.name] || {};
                                    for (var i = 0; i < e.length; i++) l[e[i]] = l[e[i]] || [], l[e[i]].push(n.name), s[n.name][e[i]] = n.to || e[i];
                                    n.to && (l[n.to] = l[n.to] || [])
                                };
                            i && (i.event = i.event || "startup", u({
                                name: i.event,
                                from: "none",
                                to: i.state
                            }));
                            ...
                            return r.current = "none", r.is = function(n) {
                                return Array.isArray(n) ? n.indexOf(this.current) >= 0 : this.current === n
                            }, r.can = function(n) {
                                return !this.transition && void 0 !== s[n] && (s[n].hasOwnProperty(this.current) || s[n].hasOwnProperty(t.WILDCARD))
                            }, r.cannot = function(n) {
                                return !this.can(n)
                                ...
                                return this.is(o)
                            }, r.error = n.error || function(n, e, t, i, o, r, a) {
                                throw a || r
                            }, r.states = function() {
                                return Object.keys(l).sort()
                            }, i && !i.defer && r[i.event](), r
                        },
                        doCallback: function(n, e, i, o, r, a) {
                            if (e) try {
                                return e.apply(n, [i, o, r].concat(a))
                            } catch (c) {
                                return n.error(i, o, r, a, t.Error.INVALID_CALLBACK, "an exception occurred in a caller-provided callback function", c)
                            }
                        },
                        ...
                        beforeEvent: function(n, e, i, o, r) {
                            return !1 === t.beforeThisEvent(n, e, i, o, r) || !1 === t.beforeAnyEvent(n, e, i, o, r) ? !1 : void 0
                        },
                        ...
                        buildEvent: function(n, e) {
                            return function() {
                                ...
                                if (this.transition) return this.error(n, i, o, r, t.Error.PENDING_TRANSITION, "event " + n + " inappropriate because previous transition did not complete");
                                if (this.cannot(n)) return this.error(n, i, o, r, t.Error.INVALID_TRANSITION, "event " + n + " inappropriate in current state " + this.current);
                                ...
                                this.transition = function() {
                                    return a.transition = null, a.current = o, t.enterState(a, n, i, o, r), t.changeState(a, n, i, o, r), t.afterEvent(a, n, i, o, r), t.Result.SUCCEEDED
                                }, this.transition.cancel = function() {
                                    a.transition = null, t.afterEvent(a, n, i, o, r)
                                };
                                var c = t.leaveState(this, n, i, o, r);
                                return !1 === c ? (this.transition = null, t.Result.CANCELLED) : t.ASYNC === c ? t.Result.PENDING : this.transition ? this.transition() : void 0
                            }
                        }
                    };
                ...
                function i(n, e) {
                    var t, i, r = e ? {} : n;
                    for (t in n) n.hasOwnProperty(t) && (i = n[t], "string" == typeof i && (i = [i]), r[t] = '<span class="nc-lang-cnt" data-nc-lang="' + t + '">' + o(d[t], i) + "</span>");
                    return r
                }
                ...
                p.zh_CN = p.cn, p.zh_TW = p.tw, p.en_US = p.en, p.iw_IL = p.iw_HE, p.pt_PT = p.pt_BR, p.ar_MA = p.ar_SA, e.language = p, e.upLang = r, e.replaceLang = a, e.upResetIndex = c
            }, function(n, e, t) {
                "use strict";
                ...
                function o() {
                    a = l.createElement("div"), a.className = "nc-h5-overlay _nc", a.innerHTML = '<div class="info"><i class="nc-iconfont icon-warn"></i><span>' + c("OVERLAY_INFORM") + "</span></div>", l.getElementsByTagName("body")[0].appendChild(a)
                }
                ...
                n.exports = function() {
                    ...
                    return /Windows/.test(n) ? "win" : /Macintosh/.test(n) ? "mac" : /Android/.test(n) ? "Android" : /(iPhone|iPad)/.test(n) ? "iOS" : /Linux/.test(n) ? "linux" : "unknow"
                }
            }, function(n, e, t) {
                "use strict";
                ...
                function i(n) {
                    ...
                    if (p.navigator.cookieEnabled && !t) {
                        ...
                        if (-1 != r) {
                            r += n.length + 1;
                            var a = _.cookie.indexOf(";", r); - 1 == a && (a = _.cookie.length), e = decodeURIComponent(_.cookie.substring(r, a)) || "", t = e
                        }
                    }
                    return t
                }
                ...
                function o(n, e, t) {
                    t = t || 7;
                    var i = new Date;
                    i.setTime(i.getTime() + 864e5 * t), _.cookie = [encodeURIComponent(n), "=", encodeURIComponent("" + e), ";expires=", i.toGMTString()].join("")
                }

                function r() {
                    var n, e = /Firefox/.test(navigator.userAgent);
                    if (e) try {
                ...
                function a(n) {
                    for (var e = ""; e.length < n;) e += Math.random().toString().substr(2);
                ...
                function i(n, e, t) {
                    ...
                    var r, a = l[n.foreign] || l[0];
                    a = s.mix(a, n.apimap), UA_Opt.LogVal = "_n", u.init(n), UA_Opt.sendMethod = 8, UA_Opt.Token = (new Date).getTime() + ":" + n.token, s.loadScript(a.uab_Url, function(n) {
                        if (AWSC) {
                            var e = function() {
                                if (window.__captchah5__uab) {
                                    if (clearInterval(t), "timeout" === window.__captchah5__uab) return void i(f);
                                    i(n)
                                }
                            };
                            AWSC.use("uab", function(n, e) {
                                "loaded" === n ? window.__captchah5__uab = e : "timeout" === n && (window.__captchah5__uab = "timeout")
                            });
                            var t = setInterval(e, 100);
                            e()
                        } else i(f)
                    }, t, n.retryTimes), setTimeout(function() {
                        i(f)
                    }, t)
                }
                ...
                function r(n, e, t) {
                    ...
                    i = s.mix(i, n.apimap),
                        function() {
                            function o() {
                                g.onload = g.onerror = null, c.body.removeChild(g), -1 != v && clearTimeout(v), e()
                            }
                            for (var r, s = ["innerWidth", "innerHeight", "outerWidth", "outerHeight", "screenX", "screenY", "availWidth", "availHeight", "colorDepth", "width", "height"], l = [], u = 0, f = s.length; f > u; u++) r = s[u], l.push(a[r] || "-");
                            var d = encodeURIComponent(l.join("|")),
                                p = i.umid_serUrl + "/dc.htm?token=" + n.token,
                                _ = navigator.userAgent;
                            _.indexOf("AppleWebKit") > 0 && navigator.vendor && -1 !== navigator.vendor.indexOf("Apple") && (p = i.umid_serUrl + "/la.htm?token=" + n.token);
                            var g, h = p + "&jsInfo=" + d;
                            _.indexOf("AppleWebKit") > 0 && navigator.vendor && -1 !== navigator.vendor.indexOf("Apple") ? (g = c.createElement("iframe"), g.src = h) : (g = new Image, g.src = h), c.body.appendChild(g), g.style.cssText = "position:absolute;top:-9999px", g.onload = g.onerror = o;
                ...
                e.init = function(n, e) {
                    ...
                    n.onenterts_verifying = function() {
                        ...
                        s.disabled = !0;
                        var l = e.options;
                        t(".icon.clear").style.display = "none", t(".icon.refresh").style.display = "none", c.postCaptcha(a, i, function(e, t, i) {
                            var r = "ok" === e && t && t.success && 100 === t.result.code,
                                a = t && t.result || {};
                            a.csessionid = i, r ? n.ts_verifypass(a) : (o++, "timeout" === e ? (n.ts_verifyerror(a), o = 0) : "number" == typeof l.errorTimes && o >= l.errorTimes ? (n.ts_verifyerror(a), o = 0) : n.ts_verifyfail(a))
                        })
                    }, n.onleavets_verifying = function() {
                        var n = t(".btn-ok");
                        n.disabled = !1;
                        var e = t(".input");
                        e.disabled = !1, t(".icon.clear").style.display = "block", t(".icon.refresh").style.display = "block"
                    }
                ...
                e.init = function(n) {
                    ...
                    e.onenterloading = function() {
                        ...
                        n.scrape = t, s.resolve().then(function() {
                            var e = n._custom_state._on_loading;
                            return e = Array.isArray(e) ? e : [], e.length > 0 ? s.all(a.map(e, function(n) {
                                return n()
                            })) : 0
                        }).then(function() {
                ...
                e.init = function(n) {
                    var e = n.fsm;
                    e.onenterneed_two_step_verify = function() {}, e.onleaveneed_two_step_verify = function() {}
                }
            }, function(n, e, t) {
                "use strict";
                var i = t(0),
                ...
                e.makeNC = function() {
                    ...
                    n.prototype = {
                        init: function(n) {
                            return this.__initialized ? void(win.console && win.console.warn("[nch5] Current NC(" + this.nc_obj.prefix + ") is already initialized!")) : (this.nc_obj.init(n), void(this.__initialized = 1))
                        }
                    }, t(75);
                    var e = t(11);
                    return n.upLang = e.upLang, n.init = function(e) {
                        var t;
                        return i(e) ? t = new r.NC2(e, c) : (t = new o.NoCaptcha, t.init(e)), n.__nc = t, t
                ...
                ! function(n, e) {
                    ...
                    if (n.getElementsByTagName("head")[0].appendChild(t), t.styleSheet) t.styleSheet.disabled || (t.styleSheet.cssText = e);
                    else try {
                        t.innerHTML = e
                    } catch (i) {
                        t.innerText = e
                ...
                i.prototype = {
                    ...
                    on: function(n, e) {
                        l.names.hasOwnProperty(n) && (this.event_listeners[n] = this.event_listeners[n] || []).push(e)
                    },
                    fire: function(n) {
                        var e, t, i = this.event_listeners[n];
                        if (i)
                            for (e = 0, t = i.length; t > e && i[e].call() !== !1; e++);
                    },
                    ...
                    _reset: function() {
                        this.container && (this.container.style.display = "block"), this.options.appkey && this.options.token && (UA_Opt.LogVal = "_n", a.init(this.options), UA_Opt.Token = (new Date).getTime() + ":" + this.options.token, UA_Opt.reload && UA_Opt.reload())
                    },
                    reset: function() {
                ...
                var o = function() {
                    ...
                    f = function() {
                        function n(e, t) {
                            i(this, n);
                            var o = "cn";
                            e.foreign && (o = "en"), this.options = c.mix({}, o, e), this.inn_vars = t, t.index++, this.index = t.index, this.jsv = t.v, this.el = document.getElementById(e.renderTo.replace(/^#/, "")), this.el || a.fail("'renderTo'(" + e.renderTo + ") does not match any node."), this.makeFSM(), this.initStates(), this.event_listeners = {}, this._custom_state = {}, this.fsm.init()
                        }
                        return o(n, [{
                            key: "makeFSM",
                            value: function() {
                                ...
                                this.fsm = r.create({
                                    ...
                                    if ("loading" !== i) {
                                        ...
                                        Array.isArray(o) && l.all(c.map(o, function(n) {
                                            return n()
                                        }))
                                    }
                                }
                            ...
                            key: "reg",
                            value: function(n, e) {
                                this._custom_state[n] = this._custom_state[n] || [], this._custom_state[n].push(e)
                            }
                        }, {
                            key: "fire",
                            value: function(n) {
                                for (var e = this.event_listeners[n] = this.event_listeners[n] || [], t = 0; t < e.length && e[t].call() !== !1; t++);
                            }
                        }, {
                            key: "reload",
                            value: function() {
                ...
                e.makeClickSlider = function(n) {
                    ...
                    function a(e) {
                        w = e, c(), p.innerHTML = o.trans(n.options.language, "LOADING"), n.on("ready", function() {
                            t("nc-iconfont icon-notclick"), p.innerHTML = '<span class="nc-iconfont icon-left-triangle"></span>' + o.trans(n.options.language, "CLICK_LABEL_READY")
                    ...
                    function s() {
                        k || (t("nc-iconfont icon-onclick"), p.style.display = "none", h.style.display = "block", n.fire("actionstart"), l(), t("nc-iconfont icon-load-c nc-loading"), k = !0, setTimeout(function() {
                            k = !1
                        }, 100))
                    }
                    ...
                    function l() {
                        ...
                        y.style.width = e.width + "px", n.slider.disable(), v.style.left = t + "px", m.style.width = t + "px", i.addClass(v, "moving"), i.addClass(m, "moving")
                    }
                    ...
                    function d() {
                        g.addEventListener("touchstart", s), g.addEventListener("click", s), v.addEventListener(b, f)
                    }
                    var p, _, g, h, v, m, y, b;
                    _ = e(".slider-holder .slider"), p = e(".click2slider-label"), g = e(".click2slide-btn"), h = e(".slider-holder"), v = e(".slider .button"), m = e(".slider .track"), y = e(".slider .track div"), b = u().end;
                    var k, w;
                    return {
                        label: p,
                        setClickBtnIcon: t,
                ...
                var _slicedToArray = function() {
                        function n(n, e) {
                            var t = [],
                                ...
                                r = void 0;
                            try {
                                for (var a, c = n[Symbol.iterator](); !(i = (a = c.next()).done) && (t.push(a.value), !e || t.length !== e); i = !0);
                            } catch (s) {
                                o = !0, r = s
                            } finally {
                                try {
                ...
                var obj_w = -1,
                    ...
                    Scrape = function() {
                        function Scrape(n) {
                            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                            _classCallCheck(this, Scrape), this.nc = n, this.prefix = n.prefix || "nc_" + n.index + "_", this.root = n.el;
                            var t = {};
                            if (e.foreign && (t.language = t.language || "en"), this.options = util.mix({}, cfg.default_options, t, n.options || {}, e), this._last_x = -1, this._last_y = -1, this.stroke_size = e.stroke_size || cfg.default_stroke_width, this.svr_data = {}, this._t_action = null, this.is_downgraded = !1, this._lang = language[this.options.language] || language.cn, this.options.upLang)
                                for (var i in this.options.upLang) this._lang = replaceLang(i, this.options.upLang[i]);
                        ...
                        return _createClass(Scrape, [{
                            ...
                            value: function() {
                                ...
                                return Promise.all(util.map(e, function(n) {
                            ...
                            value: function() {
                                ...
                                return Promise.resolve().then(function() {
                                    return window.__captchah5__uab.resetSA && window.__captchah5__uab.resetSA(), n.loading_render()
                                })
                            }
                        }, {
                            key: "getParamOl",
                            ...
                            value: function() {
                                ...
                                return new Promise(function(e, t) {
                                    ...
                                    util.jsonp(n.ajaxURL.api_prepare, {
                                        a: i.appkey,
                                        t: i.token,
                                        scene: i.scene,
                                        ...
                                        if ("ok" === i && (i = ""), i || !o.success) return void t(i || "data fail");
                                        if (!o.result || !o.result.result) return void t("bad data");
                                        try {
                                            n._prepare_result = o.result.result, n.parsePrepareData(n._prepare_result)
                                        } catch (r) {
                                            return void t("prepare data parse fail!")
                                        }
                                        n.putObjects();
                                        var a = n.getEl("inform");
                                        a.style.display = "block", a.innerHTML = n._lang._ggk_start, n.showHow(), n.scrapeStart = !1, util.addClass(n.root, "nc-prepared"), util.removeClass(n.root, "nc-state-load-error");
                            ...
                            value: function() {
                                var n = this,
                                    ...
                                    t = e.objectPoints,
                                    i = t.points;
                                if (this._points = i, !i || !Array.isArray(i) || i.length !== t.objectPointsCount) throw new Error("Bad data: objectPoints.length is not equal to objectCounts!");
                                var o = this.getEl("bg");
                                o.innerHTML = util.map(i, function(e, t) {
                                    var i = e.x,
                                        o = e.y,
                                        r = i - n.obj_w / 2,
                                        a = o - n.obj_h / 2,
                            ...
                            value: function() {
                                ...
                                return this.el_nc_canvas = i, e || (n.width = i.offsetWidth), n.width < cfg.min_width && (n.width = cfg.min_width), styleEl(i, "width", n.width + "px"), t || (n.height = i.offsetHeight), n.height < cfg.min_height && (n.height = cfg.min_height), styleEl(i, "height", n.height + "px"), n
                            }
                        }, {
                            key: "render_bg",
                            value: function() {
                            ...
                            value: function() {
                                var n = this,
                                    ...
                                    t = this.size.width,
                                    i = this.size.height;
                                e.style.width = t + "px", e.style.height = i + "px", e.style.display = "block";
                                for (var o = cfg.grid_size, r = Math.ceil(t / o), a = Math.ceil(i / o), c = [], s = this.options.bg_back, l = 0; a > l; l++)
                                    for (var u = 0; r > u; u++) {
                                        var f = o * l,
                                            d = o * u,
                                            p = {
                            ...
                            value: function() {
                                ...
                                l.src = this.options.bg_front, l.onload = function() {
                                    ...
                                    for (var n = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], e = _slicedToArray(n, 2), o = e[0], r = e[1], a = Math.ceil(i.width / o), c = Math.ceil(i.height / r), s = 0; c > s; s++)
                            ...
                            value: function(n, e) {
                                ...
                                var t = this.ctx;
                                t.fillStyle = "#fff", t.beginPath(), t.arc(n, e, this.stroke_size / 2, 0, 2 * Math.PI), t.fill(), this._last_x >= 0 && this._last_y >= 0 && (t.beginPath(), t.lineWidth = this.stroke_size, t.moveTo(this._last_x, this._last_y), t.lineTo(n, e), t.stroke()), this._last_x = n, this._last_y = e
                            }
                        }, {
                            key: "_calcRegion",
                            value: function(n, e, t, i) {
                                for (var o = this.ctx.getImageData(n, e, t, i).data, r = 0, a = 0; a < o.length; a += 4) o[a] && o[a + 1] && o[a + 2] && o[a + 3] && r++;
                                return 1 - r / t / i
                            }
                        }, {
                            key: "_calcRegion_dg",
                            value: function(n, e, t, i) {
                                for (var o = cfg.grid_size, r = Math.floor(n / o), a = Math.floor(e / o), c = Math.floor(t / o), s = Math.floor(i / o), l = 0, u = a; a + s > u; u++)
                                    for (var f = r; r + c > f; f++) {
                            ...
                            value: function() {
                                ...
                                var o = this.is_downgraded ? .7 : .9,
                                    r = this.obj_w / 2 * o,
                                    a = this.obj_h / 2 * o;
                                return t = util.map(this._points, function(e) {
                                    var t = e.x,
                                        i = e.y;
                            ...
                            key: "checkEnd",
                            value: function(n, e) {
                                var t = 0 === e.filter(function(n) {
                                    return .5 > n
                                }).length;
                                if ((n > .9 || t) && window.__captchah5__uab.isReadyForSC(window.__captchah5_uaboption.mIDs) && "ready" === this.nc.fsm.current) this.verify();
                                else if (n > .9 && t) {
                                    try {
                                        UA_Opt.sendSA()
                                    } catch (i) {}
                            ...
                            value: function verifyMethod() {
                                ...
                                return clearTimeout(this._t_action), new Promise(function(resolve, reject) {
                                    ...
                                    win._n_bak = win._n, util.jsonp(_this10.ajaxURL.api_analyze, {
                                        a: options.appkey,
                                        t: options.token,
                                        ...
                                        if ("ok" === n && (n = null), n) {
                                            ...
                                            return t = _this10._updateSurveyUrl(t), _this10._fail_msg = t, void reject("net fail!")
                                        }
                                    ...
                                    UA_Opt.reload(), window.__captchah5__uab.resetSA(), _this10.nc._err = _this10.nc._err || "4A", _this10.verify_fail()
                                })
                            }
                        }, {
                            key: "verify_ok",
                            ...
                            value: function(n) {
                                ...
                                switch (n) {
                                    case FAIL_PREPARE:
                                        !t && this.nc._log(FAIL_PREPARE, "prepare timeout", "{code: 401}"), o = "2A", a = "401";
                                        break;
                                    case FAIL_ANALYZE:
                                        !t && this.nc._log(FAIL_ANALYZE, "analyze timeout", "{code: 404}"), o = "2D", a = "404";
                                        break;
                                    case "TIMEOUT_uab":
                                        !t && this.nc._log("TIMEOUT_uab", "uab.js timeout", "{code: 403}"), o = "2C", a = "403";
                                        break;
                                    case "TIMEOUT_um":
                                        !t && this.nc._log("TIMEOUT_um", "um.js timeout", "{code: 402}"), o = "2B", a = "402"
                                }
                                switch (o) {
                                    case "3A":
                                        r = r.concat(e), !t && this.nc._log("ERR_SLIDE_TOO_FAST", "too few mp", "{code: 201, str:" + r + "}"), a = "201";
                                        break;
                                    case "4A":
                                        e = [this.session_id, win._n_bak], r = r.concat(e), !t && this.nc._log(ERR_CODE_API_FAIL + "_analyze", "blocked", "{code: 101, str:" + r + "}"), a = "101";
                                        break;
                                    case "5A":
                                        e = [this.session_id, win._n_bak], r = r.concat(e), !t && this.nc._log(ERR_CODE_API_FAIL + "_analyze", "blocked", "{code: 301, str:" + r + "}"), a = "301"
                                }
                                return i.failCallback && i.failCallback("{code: " + a + ", str:" + r + "}"), {
                                    type: o,
                                    str: r.map(function(n) {
                            ...
                            value: function(n, e, t) {
                                ...
                                return n = n.replace(/%TYPE\b/, i.type), n = n.replace(/%STR\b/, i.str), n = this._upResetIndex(n)
                            }
                        }, {
                            key: "on_load_error",
                            value: function(n) {
                                ...
                                return new Promise(function(n, t) {
                                    util.addClass(e.root, "nc-state-load-error"), util.removeClass(e.root, "nc-prepared");
                                    var i = function o() {
                                        var t = e.getEl("load-error"),
                                            i = void 0,
                                            r = e.getEl("cover");
                                        if (!e.size || !r) return void setTimeout(o, 10);
                                        e.showEl("load-error"), i = e.size ? e.size.height : r.offsetHeight, t.style.marginTop = (i - 80) / 2 + "px";
                                        var a = e._lang._ggk_net_err;
                                        a = e._updateSurveyUrl(a), e.getEl("load-error-msg").innerHTML = a, e.tryToUpdateErrIcon(), n()
                                    };
                                    i()
                                })
                            }
                            ...
                            value: function() {
                                ...
                                return clearTimeout(this._t_action), Promise.resolve().then(function() {
                                    n.hideEl("canvas-dg");
                                    var e = n.getEl("ok");
                                    e.style.marginTop = (n.size.height - 80) / 2 + "px", n.getEl("ok-msg").innerHTML = n._lang._ggk_success;
                            ...
                            value: function() {
                                ...
                                return clearTimeout(this._t_action), Promise.resolve().then(function() {
                                    ...
                                    t = n._updateSurveyUrl(t, "", !0), n.getEl("fail-msg").innerHTML = t, n._fail_msg = "", n.tryToUpdateErrIcon();
                            ...
                            value: function() {
                                ...
                                return Promise.resolve().then(function() {
                                    var e = n.getEl("fail");
                                    e.style.marginTop = (n.size.height - 80) / 2 + "px", n.hideEl("canvas-dg"), n.nc._err = "5A";
                            ...
                            value: function(n) {
                                ...
                                if ("ready" == this.nc.fsm.current) {
                                    ...
                                    var t = this.getPos(n),
                                        ...
                                        o = i[0],
                                        r = i[1];
                                    this._clearTo(o, r), this._old_onselectstart = doc.body.onselectstart, this._old_ondrag = doc.body.ondrag, this.is_downgraded && (doc.body.onselectstart = doc.body.ondrag = function() {
                                        return !1
                                    })
                                }
                            }
                            ...
                            value: function(n) {
                                ...
                                if (this.mousedown) {
                                    clearTimeout(this._t_action), "ready" === this.nc.fsm.current && (this._t_action = setTimeout(function() {
                                        e.actionTimeout()
                                    }, cfg.action_timeout)), n.changedTouches && (n = n.changedTouches[n.changedTouches.length - 1]);
                                    var i = this.getPos(n),
                            ...
                            value: function() {
                                var n = this.size,
                                    ...
                                    r = Math.ceil(t / i),
                                    a = o * r;
                                this._grid_x_count = o, this.matrix = util.fill(new Array(a), 1), this._grid_sum = a
                            }
                        }, {
                            key: "downgrade",
                            value: function() {
                            ...
                            value: function() {
                                ...
                                return new Promise(function(e, t) {
                                    try {
                                        var i = n.nc;
                                        if (n.root.innerHTML = kvTpl.render(html, {
                                                nc: i,
                                                prefix: n.prefix,
                                                inform: "",
                                            ...
                                            }), n.showEl("loading"), n.hideEl("load-error"), n.getEl("title").innerHTML = n._lang._ggk_guide, n.bindEvents(), n.size = n.getSize(), n.getEl("container").style.width = n.size.width + "px", n.render_bg(), n.el_canvas = n.getEl("canvas"), !n.el_canvas.getContext || !(n.ctx = n.el_canvas.getContext("2d"))) return n.downgrade(), n.render_surface_dg(), void e();
                                        n.render_surface(), e()
                                    } catch (o) {
                                        t(o)
                                    }
                ...
                e.makeFSM = function(n) {
                    ...
                    return e.onleavestate = function(n, e, t) {}, e.onenterstate = function(n, e, t) {}, t(89).init(e, n), t(88).init(e, n), t(92).init(e, n), t(99).init(e, n), t(87).init(e, n), t(86).init(e, n), t(91).init(e, n), t(90).init(e, n), t(96).init(e, n), t(98).init(e, n), t(29).init(e, n), t(95).init(e, n), t(94).init(e, n), t(97).init(e, n), t(93).init(e, n), t(85).init(e, n), e
                }
            }, function(n, e, t) {
                "use strict";
                var i = window,
                ...
                e.makeNet = function(n, e) {
                    ...
                    function s() {
                        var n = {
                            ...
                            e = {};
                        try {
                            navigator.connection ? (e.cntp = encodeURIComponent(navigator.connection.type), e.cneftp = encodeURIComponent(navigator.connection.effectiveType)) : e.cn = "ns"
                        } catch (i) {
                            e.cn = "e_cn"
                        }
                        try {
                            if (navigator.getBattery) {
                                var o = Promise.race([navigator.getBattery().then(function(n) {
                                ...
                                o.then(function(i) {
                                    n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                                        "ok" === n && e && e.success && 0 === e.result.code, e && e.result ? e.result : {}
                                    }, _.timeout || 1e4)
                                })["catch"](function(i) {
                                    e.btry = "ab", n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                                        "ok" === n && e && e.success && 0 === e.result.code, e && e.result ? e.result : {}
                                    }, _.timeout || 1e4)
                                })
                            } else e.btry = "ns", n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                                "ok" === n && e && e.success && 0 === e.result.code, e && e.result ? e.result : {}
                            }, _.timeout || 1e4)
                        } catch (i) {
                            e.btry = "e_btry", n.comm = JSON.stringify(e), t(h.initialize, n, function(n, e) {
                                "ok" === n && e && e.success && 0 === e.result.code, e && e.result ? e.result : {}
                            }, _.timeout || 1e4)
                        }
                    }
                    ...
                    function f(n) {
                        return parseInt(n.offsetWidth + "a" + n.offsetHeight + "a" + l(n) + "a" + u(n), 11).toString(16)
                    }
                    ...
                    function d(n) {
                        ...
                        try {
                            r.ncSessionID = f(document.getElementById(e.prefix + "-stage-1").getElementsByTagName("div")[0])
                        } catch (l) {
                            r.ncSessionID = "0"
                        }
                        try {
                        ...
                        t(h.analyze, u, function(t, i) {
                            var o = "ok" === t && i && i.success && 0 === i.result.code,
                                r = i && i.result ? i.result : {};
                            e.sid = g = r.csessionid, e.captcha_type = r.value, n({
                                pass: o,
                                state: t
                            }, r)
                        }, _.timeout || 1e4)
                ...
                e.makeSlider = function(n) {
                    ...
                    function t(e) {
                        if ("ready" == n.fsm.current && !w) {
                            ...
                            x = A - o, i.addEventListener("touchmove", c, !0), i.addEventListener("mousemove", c, !0), n.fire("actionstart")
                        }
                    }

                    function a() {
                        w = !1, i.removeEventListener("touchmove", c, !0), i.removeEventListener("mousemove", c, !0), T > X && (o.addClass(m, "mv-back"), o.addClass(y, "mv-back"), m.style.left = "0", y.style.width = g + "px", setTimeout(function() {
                            o.delClass(m, "mv-back"), o.delClass(y, "mv-back")
                        }, 500))
                    }

                    function c(e) {
                        e.preventDefault(), X = (e.touches ? e.touches[0] : e).clientX + x, A > X ? X = A : X > T && (X = T);
                        var t = X - A;
                        m.style.left = t + "px", y.style.width = t + g + "px", X == T && (a(), n.fire("actionend"), h && h())
                    }

                    function s() {
                        m.addEventListener("touchstart", t), m.addEventListener("touchend", a), m.addEventListener("mousedown", t), m.addEventListener("mouseup", a), k.addEventListener("touchstart", t), k.addEventListener("touchend", a), k.addEventListener("mousedown", t), k.addEventListener("mouseup", a)
                    }

                    function l() {
                        m.removeEventListener("touchstart", t), m.removeEventListener("touchend", a), m.removeEventListener("mousedown", t), m.removeEventListener("mouseup", a), k.removeEventListener("touchstart", t), k.removeEventListener("touchend", a), k.removeEventListener("mousedown", t), k.removeEventListener("mouseup", a)
                    }
                    ...
                    function p(t) {
                        h = t, v = e(".slider"), m = e(".button"), y = e(".track"), b = e(".track div"), k = e(".label"), k.innerHTML = r.trans(n.options.language, "LOADING");
                ...
                "use strict";
                e.init = function(n, e) {
                    n.onreset = function() {}, n.onbeforereset = function() {
                ...
                e.init = function(n, e) {
                    n.onenterfail = function() {
                        function n(n, e, t) {
                            for (var i = 0, o = e, r = n.length; r > o;) i <<= 3, i += n.charCodeAt(o), o += t;
                            0 > i && (i = 0 - i);
                ...
                e.init = function(n, e) {
                    ...
                    n.onenterloading = function() {
                        ...
                        /windvane/i.test(navigator.userAgent) && r.loadScript(n, function() {
                            i.WindVane && i.WindVane.call("aluWVJSBridge", "getUmid", {}, function(n) {
                                e.inner_trans.nc_wvumidToken = n.aluUmid
                            })
                        }), e.ui = a(e), e.ui.init(), e._reset(), o.load(e, function(n) {
                            n ? e.fsm.loaderror() : e.fsm.load()
                        });
                        var s = c(".label");
                        s.innerHTML = t("LOADING"), e.slider.setIcon("nc-loading nc-iconfont icon-load-c"), e.fire("init")
                ...
                e.init = function(n, e) {
                    ...
                    n.onenterpass = function(n, i, o, r) {
                        ...
                        var a = e.options;
                        r.sig = r.sig || r.value, "function" == typeof a.callback && a.callback(r), e.fire("success");
                        var c;
                        c = !a.hasOwnProperty("bannerHidden") || a.bannerHidden, setTimeout(function() {
                ...
                e.init = function(n, e) {
                    ...
                    n.onenterready = function() {
                        ...
                        if (r.addEventListener("click", function() {
                            ...
                            c.style.backgroundImage = "url(" + o + ")", c.style.backgroundPosition = "0 50%", c.style.backgroundRepeat = "repeat-x"
                        }
                        e.fire("ready")
                    }
                }
                ...
                e.init = function(n, e) {
                    ...
                    function i() {
                        var n = t(".tips");
                        n.style.display = "block", o > 0 && clearTimeout(o), o = setTimeout(function() {
                    ...
                    n.onenterts_fail = function() {
                        var n = e.options;
                        UA_Opt.Token = (new Date).getTime() + ":" + n.token, UA_Opt.reload && UA_Opt.reload(), e.updateImg(), i(), e.fire("fail")
                    }
                }
            }, function(n, e, t) {
                "use strict";
                ...
                e.init = function(n, e) {
                    ...
                    function c() {
                        function i() {
                            ...
                            k.style.display = n ? "block" : "none", v.style.display = n ? "none" : "block", y.disabled = n
                        }
                        ...
                        function c(t) {
                            ...
                            o.jsonp(u.get_img, i, function(e, i) {
                        ...
                        function f(t) {
                            return "ts_verifying" !== n.current && (t && e.fire("beforeverify"), void c(function(n) {
                                s = n, _ = s.result.data[0], r.setCaptchaToken(s.result.captchaToken), g.src = _, g.onload = function() {
                        ...
                        var _, g = a("img.code"),
                            ...
                            b = a(".tips"),
                            k = a(".placeholder");
                        k.innerHTML = t("TEXTBOX_HOLDER"), y.innerHTML = t("BUTTON_OK"), b.innerHTML = t("TIPS_TITLE"), m.onclick = d, g.onclick = d, e.updateImg = f;
                        var w = 0,
                            x = 10;
                        g.onerror = function() {
                            var n = -1 === _.indexOf("?") ? "?" : "&";
                            w++, w >= e.options.retryTimes || w > x || setTimeout(function() {
                                g.src = _ + n + "__retry=" + w
                            }, 1e3)
                        }, f()
                    }
                    var s, l = e.options,
                        u = i[l.foreign] || i[0];
                    u = o.mix(u, l.apimap), n.onenterts_loading = function(i, o, r, a) {
                        e.slider.setTitle(t("CHECK_N"), "red"), e.slider.setIcon("no nc-iconfont icon-close"), e.options.verifycallback && e.options.verifycallback(a), setTimeout(function() {
                    ...
                    n.onenterverifying = function() {
                        function n() {
                            e.net.postSlide(function(n, t) {
                                return -1 != i && clearTimeout(i), "timeout" === n.state ? void(e.fsm.can("verifyerror") && e.fsm.verifyerror(t)) : (n.pass ? e.fsm.can("verifypass") && e.fsm.verifypass(t) : 300 == t.code ? e.fsm.can("verifyfail") && e.fsm.verifyfail(t) : e.fsm.can("verifytwostep") && e.fsm.verifytwostep(t), void(e.options.isClick && e.slider.setIcon("nc-hidden")))
                            })
                        }
                        e.slider.disable();
                        var i = setTimeout(function() {
                            i = -1, e.slider.setTitle(t("LOADING")), e.slider.setIcon("nc-loading nc-iconfont icon-load-c")
                        }, 100);
                        n()
                ...
                e.makeUI = function(n) {
                    ...
                    function l() {
                        var e;
                        for (e = 1; 3 >= e; e++) g[e] = t("#" + n.prefix + "-stage-" + e), g[e].style.display = "none";
                        u(1)
                    }
                    ...
                    function u(e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                            i = g[h];
                        if (i && (i.style.display = "none"), i = g[e], i.style.display = "block", h = e, 3 == e && t) {
                            var o = document.getElementById(n.prefix + "-stage-3").getElementsByTagName("div")[0].innerHTML;
                            o = o + "(" + t + ")", document.getElementById(n.prefix + "-stage-3").getElementsByTagName("div")[0].innerHTML = o
                        }
                        2 !== e || v.inline || f()
                    }
                    ...
                    function d() {
                        function i() {
                            ...
                            u.style.display = e ? "block" : "none", "ts_verifying" === n.fsm.current && (e = !0), s.disabled = e, c.style.display = e ? "none" : "block"
                        }
                        ...
                        var a = t(".input"),
                            ...
                            l = t(".tips"),
                            u = t(".placeholder");
                        u.innerHTML = e("TEXTBOX_HOLDER"), s.innerHTML = e("BUTTON_OK"), l.innerHTML = e("TIPS_TITLE"), setInterval(i, 500), a.onkeydown = function(n) {
                            13 == n.keyCode ? r() : setTimeout(i, 0)
                        }, a.onchange = i, c.onclick = o, s.onclick = r
                    }
                    ...
                    function p() {
                        var o = t(".menu.refresh"),
                            r = t(".menu.feedback");
                        o.onclick = function() {
                            "load_error" == n.getState() ? (n.fsm.continueloading(), n.slider.enable()) : n.has("refresh") ? n.fire("refresh") : location.reload()
                        }, r.onclick = function() {
                            i.open(e("FEEDBACK_URL"))
                        }, t(".stage3 .title").innerHTML = e("ERROR_TITLE"), t(".menu.refresh .label").innerHTML = e("ERROR_RELOAD"), t(".menu.feedback .label").innerHTML = e("ERROR_FEEDBACK")
                    }
                    var _ = {},
                        g = [],
                        h = -1,
                        v = n.options;
                    return _.setActiveStage = u, _.init = function() {
                        o.hide(n.prefix), n.container.innerHTML = r.make(n.prefix, v.isClick), s.addClass(n.container, "nc-container"), n.slider = a.makeSlider(n), n.slider.init(function() {
                            n.fsm.can("verify") && n.fsm.verify()
                        }), n.options.isClick && (n.click2slider = c.makeClickSlider(n), n.click2slider.init(function() {
                            n.fsm.can("verify") && n.fsm.verify()
                        }), n.click2slider.enable()), d(), p(), l()
                    }, _
                }
            }, function(n, e, t) {
                "use strict";
                ...
                }, i.resolve = o, n.exports = i, i.id = 134
            }])
        };
